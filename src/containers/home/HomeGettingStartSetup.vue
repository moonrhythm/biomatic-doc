<template>
  <div>
    ...
    <div class="_bgcl-neutral-300 _bdrd-2px _pdh-16px _pdv-16px">
      ...
      <p class="_mgbt-16px _fs-5 _mgt-8px"><strong>วิธีที่หนึ่ง – </strong> <a class="bio-link -fancy" href="https://github.com/BioMaRu/biomatic/releases/download/v0.0.6/biomatic.full.min.css.zip">ดาวน์โหลด CSS</a> และลิงค์ไปยัง Project ของของคุณด้วย</p>
      ...
      <pre class="_mgbt-8px"><code class="language-markup">yarn add biomatic</code></pre>
    </div>
  </div>
</template>
